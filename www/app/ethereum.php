...
{
	private function ether_request($method, $params=array(),$block='')
	{
		try 
		{
			$ret = $this->request($method, $params,$block);
			return $ret->result;
		}
    ...
    function eth_call($message,$block='')
    {
        ...
        //else
        //{
            return $this->ether_request(__FUNCTION__, $message,$block);
        //}
    }

    function createAddrParam($addr) {
